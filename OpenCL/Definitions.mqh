...
// OpenCL scaler types is consistent with MQL.
/* scalar types  */
#define cl_char char
...
#define CL_LONG_MAX         LONG_MAX
#define CL_LONG_MIN         LONG_MIN
#define CL_ULONG_MAX        ULONG_MAX
...
#define CL_FLT_EPSILON      1.0/(1>>23)
...
#define cl_platform_id intptr_t
#define cl_device_id intptr_t
#define cl_context intptr_t
#define cl_command_queue intptr_t
#define cl_mem intptr_t
#define cl_program intptr_t
#define cl_kernel intptr_t
#define cl_event intptr_t
#define cl_sampler intptr_t
...
#define cl_device_svm_capabilities      cl_bitfield
#define cl_command_queue_properties     cl_bitfield
#define cl_device_partition_property    intptr_t
#define cl_device_affinity_domain       cl_bitfield

#define cl_context_properties           intptr_t
#define cl_context_info                 cl_uint
#define cl_queue_properties             cl_bitfield
#define cl_command_queue_info           cl_uint
#define cl_channel_order                uint
#define cl_channel_type                 uint
#define cl_mem_flags                    cl_bitfield
#define cl_svm_mem_flags                cl_bitfield
#define cl_mem_object_type              uint
#define cl_mem_info                     uint
#define cl_mem_migration_flags          cl_bitfield
#define cl_image_info                   uint
#define cl_buffer_create_type           uint
#define cl_addressing_mode              uint
#define cl_filter_mode                  uint
#define cl_sampler_info                 uint
#define cl_map_flags                    cl_bitfield
#define cl_pipe_properties              intptr_t
#define cl_pipe_info                    uint
#define cl_program_info                 uint
#define cl_program_build_info           uint
#define cl_program_binary_type          uint
#define cl_build_status                 int
#define cl_kernel_info                  uint
#define cl_kernel_arg_info              uint
#define cl_kernel_arg_address_qualifier uint
#define cl_kernel_arg_access_qualifier  uint
#define cl_kernel_arg_type_qualifier    cl_bitfield
#define cl_kernel_work_group_info       uint
#define cl_kernel_sub_group_info        uint
#define cl_event_info                   uint
#define cl_command_type                 uint
#define cl_profiling_info               uint
#define cl_sampler_properties           cl_bitfield
#define cl_kernel_exec_info             uint
//+------------------------------------------------------------------+
//|                                                                  |
//+------------------------------------------------------------------+
